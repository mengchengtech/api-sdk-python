...
from openapi.sdk import RequestOption, AsyncOpenApiClient, OpenApiResponseError, SignedByQuery, QuerySignatureParams


class AsyncApiClientTest(unittest.IsolatedAsyncioTestCase):
    _config: Config
    ...
    def __init__(self, methodName: str = 'runTest'):
        ...
        self.addAsyncCleanup(self._client.aclose)
    ...
    async def test_get_by_header(self):
        ...
        async with await self._client.get(self._config.api_path, option) as result:
            jo = await result.get_json_object()
    ...
    async def test_post_by_header(self):
        ...
        with self.assertRaises(OpenApiResponseError) as ctx:
            await self._client.post(self._config.api_path, option)
